          ...
          <tbody>
            <tr>
			  ...
			  <br/>
                    ...
                    <span id="ccrcontent">
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:MedicalHistories">
                        <tr id="medicalhistoriesrow">
                          <td>
                            <span class="header">Medical Histories</span>
                            <br/>
                            <table class="list" id="medicalhistories">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:MedicalHistories/a:MedicalHistory">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:Type/a:Text"/>
                                    </td>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:SurgicalHistories">
                        <tr id="surgicalhistoriesrow">
                          <td>
                            <span class="header">Surgical Histories</span>
                            <br/>
                            <table class="list" id="surgicalhistories">
                              <tbody>
                                <tr>
                                  <th>Surgery</th>
                                  <th>Type</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:SurgicalHistories/a:SurgicalHistory">
                                  <tr>
                                    <td>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:SocialHistories">
                        <tr id="socialhistoriesrow">
                          <td>
                            <span class="header">Social Histories</span>
                            <br/>
                            <table class="list" id="socialhistories">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Routine</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:SocialHistories/a:SocialHistory">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:Type/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Routine/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Substance/a:Text"/>
                                    </td>
                                    <td>
                                      <table class="internal">
                                        <tbody>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:FamilyHistories">
                        <tr id="familyhistoriesrow">
                          <td>
                            <span class="header">Family Histories</span>
                            <br/>
                            <table class="list" id="familyhistories">
                              <tbody>
                                <tr>
                                  <th>Relationship</th>
                                  <th>Name</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:FamilyHistories/a:FamilyHistory">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:Relationship/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Name/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Problem/a:Text"/>
                                    </td>
                                    <td>
                                      <strong class="clinical">
                                        <xsl:value-of select="a:Description/a:Text"/>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Allergies">
                        <tr id="allergiesrow">
                          <td>
                            <span class="header">Allergies</span>
                            <br/>
                            <table class="list" id="allergies">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Agent</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Allergies/a:Allergy">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:Type/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Agent/a:Text"/>
                                    </td>
                                    <td>
                                      <strong class="clinical">
                                        <xsl:value-of select="a:Reactions/a:Text"/>
                                      </strong>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Status/a:Text"/>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Problems">
                        <tr id="problemsrow">
                          <td>
                            <span class="header">Problem Lists</span>
                            <br/>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Labs">
                        <tr id="labsrow">
                          <td>
                            <span class="header">Labs</span>
                            <br/>
                            <table class="list" id="labs">
                              <tbody>
                                <tr>
                                  <th>Test Name</th>
                                  <th>Specimen</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Labs/a:Lab">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:TestName/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Specimen/a:Text"/>
                                    </td>
                                    <td>
                                      <table class="internal">
                                        <tbody>
                                    ...
                                    <td>
                                      <xsl:value-of select="a:TestResult/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:NormalRange/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Status/a:Text"/>
                                    </td>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Radiologies">
                        <tr id="radiologiesrow">
                          <td>
                            <span class="header">Radiologies</span>
                            <br/>
                            <table class="list" id="radiologies">
                              <tbody>
                                <tr>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Radiologies/a:Radiology">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:ProcedureName/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:BodySite/a:Text"/>
                                    </td>
                                    <td>
                                      <table class="internal">
                                        <tbody>
                                    ...
                                    <td>
                                      <xsl:value-of select="a:Laterality/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:TestResult/a:Text"/>
                                    </td>
                              ...
                              <tbody>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Procedures/a:Procedure ">
                                  <tr>
                                    ...
                                    <td>
                                      <xsl:value-of select="a:Details/a:Text"/>
                                    </td>
                                    <td>
                                      <strong class="clinical">
                                        <xsl:value-of select="a:Description/a:Text"/>
                            ...
                            <table class="list" id="immunizations">
                              <tbody>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Immunizations/a:Immunization ">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:VaccineName/a:Text"/>
                                    </td>
                                    <td>
                                      <table class="internal">
                                        <tbody>
                                    ...
                                    <td>
                                      <xsl:value-of select="a:LotNumber/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Manufacturer/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:Dose/a:Text"/>
                                    </td>
                                    <td>
                                      <xsl:value-of select="a:BodySite/a:Text"/>
                                    </td>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Injections">
                        <tr id="injectionsrow">
                          <td>
                            <span class="header">Injections</span>
                            <br/>
                            <table class="list" id="injections">
                              <tbody>
                                <tr>
                                  <th>Injection</th>
                                  <th>Date</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Injections/a:Injection ">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:InjectionName/a:Text"/>
                                    </td>
                                    <td>
                                      <table class="internal">
                                        <tbody>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Medicals">
                        <tr id="medicalsrow">
                          <td>
                            <span class="header">Medical Lists</span>
                            <br/>
                            <table class="list" id="medicals">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Medicals/a:Medical">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:Type/a:Text"/>
                                    </td>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Referrals">
                        <tr id="referralsrow">
                          <td>
                            <span class="header">Referrals</span>
                            <br/>
                            <table class="list" id="referrals">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Referrals/a:Referral">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:Type/a:Text"/>
                                    </td>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:HealthMaintenances">
                        <tr id="healthmaintenancesrow">
                          <td>
                            <span class="header">Health Maintenance</span>
                            <br/>
                            <table class="list" id="healthmaintenances">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:HealthMaintenances/a:HealthMaintenance">
                                  <tr>
                                    <td>
                                      <xsl:value-of select="a:Type/a:Text"/>
                                    </td>
...
--&gt;</style>
  ...
  The stylesheet used to generate this view of the CCR was provided by OTEMR.
</font>
          </th>
        </tr>
        <tr>
