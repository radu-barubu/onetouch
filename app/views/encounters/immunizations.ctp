...
<script language="javascript" type="text/javascript">
	...
	<div style="overflow: hidden;" id="main_content">
		<form id="frmInHouseWorkProdecure" method="post" action="<?php echo $thisURL. '/task:delete'; ?>" accept-charset="utf-8" enctype="multipart/form-data">
			...
			<?php if(!empty($EncounterPointOfCare)) { ?>
				...
				echo $paginator->sort('Immunization Name', 'vaccine_name', array('model' => 'EncounterPointOfCare', 'class' => 'ajax'));?></th>
			...
			foreach ($EncounterPointOfCare as $EncounterPointOfCare):
				$i++;
			?>
				<tr editlinkajax="<?php echo $html->url(array('action' => 'results_immunizations', 'task' => 'edit', 'encounter_id' => $encounter_id, 'point_of_care_id' => $EncounterPointOfCare['EncounterPointOfCare']['point_of_care_id']), array('escape' => false)); ?>" style="cursor:pointer;">
