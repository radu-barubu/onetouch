...
function initPage()
{
	$("#table_alert_data tr:nth-child(odd)").addClass("striped");
	...
	$('#btnGenerate').click(function() {initAutoLogoff(); $("#frm_alert_report").submit();});
...
function executePage(url)
{
	...
	$.ajax(
	{
		type: "POST",
		url: url,
		data: $("#frm_alert_report").serialize(),
...
$(document).ready( function() 
{
	...
	$("#frm_alert_report").validate(
	{
		debug: true, 
		errorElement: "span",
		submitHandler: function(form) 
		{
			executePage('alert_data');
			return true;
		}
	});
