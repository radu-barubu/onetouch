...
$(document).ready( function() 
{
	...
	$("#frm_clinical_report").validate(
	{
		...
		{
			executePage('health_surveillance_data');
			return true;
		}, 
		rules:
		{
...
<div style="overflow: hidden;">
    <form id="frm_clinical_report">
        ...
        <table cellpadding="0" cellspacing="0" class="form">
            ...
            <input name="data[list_diagnosis_registries]" id='list_diagnosis_registries' value="true" type='hidden'>
