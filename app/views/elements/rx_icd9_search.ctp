<script language="javascript" type="text/javascript">
    var icd9_result_link = '<?php echo $html->url(array('controller' => 'preferences', 'action' => 'rx_icd9_search')); ?>';
    var icd9_submit_func = <?php echo $submit; ?>;
    var open_id = '<?php echo $open; ?>';
    var icd9_container_id = '<?php echo $container; ?>';
	var icd9_type = '<?php echo $input_type; ?>';
</script>

<?php echo $this->Html->script(array('sections/rx_icd9_search.js?' . md5(microtime()))); ?>
