...
?>
    ...
    var titleText = 'Weight-for-stature Chart for Girls';
    ...
    $(document).ready(function() {
        ...
        $.post(csvFilePath, function(data)
        {
            ...
            <?php
            $current_length = (int)$length * 2.54;
                $current_weight = (int)$weight;
            ?>
                    var dot = { data: [[<?php echo $current_length; ?>, <?php echo $current_weight; ?>]],marker:{ symbol: "circle", radius: 5},showInLegend:false};
                dot.type = 'scatter';
                dot.name = 'Weight';
