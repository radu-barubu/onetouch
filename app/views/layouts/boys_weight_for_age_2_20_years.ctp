...
?>
    ...
    var titleText = 'Weight-for-age Chart';
    var csvFilePath = '<?php echo $this->Html->url(array('controller' => $current_controller, 'action' => 'vitals', 'task' => 'growthpoints', 'name' => 'weight_age', 'encounter_id' => $encounter_id)); ?>';
    $(document).ready(function() {
        ...
        $.post(csvFilePath, function(data)
        {
            ...
            var dot = { data: [[<?php echo $age; ?>, <?php echo $weight; ?>]],marker:{ symbol: "circle", radius: 5},showInLegend:false};
            dot.type = 'scatter';
            dot.name = 'Weight';
            options.series.push(dot);
            
            var dot = { data: <?php echo json_encode($previous_values['weight_age_in_month']); ?>, marker:{ symbol: "circle", radius: 3}, showInLegend:false};
            dot.type = 'scatter';
            dot.lineWidth = 1;
            dot.name = 'Weight';
            options.series.push(dot);
...
<!-- 3. Add the container -->
<div id="container" style="width: 800px; height: 700px; margin: 0 auto; position: relative;"></div>
