		...
		<div class="title_text">
			<table id="sub_tab_table">
					<tr>
					   ...
					   <td width="15">&nbsp;</td>
					   <td> 
							<a href="javascript:void(0);" class="poc_submenuitem active" url="<?php echo $html->url(array('controller' => 'patients', 'action' => 'poc_injection')); ?>" style="float: none;">Injections</a>
					   </td>
					   <td width="15">&nbsp;</td> 					      
					   <td> 
							<a href="javascript:void(0);" class="poc_submenuitem" url="<?php echo $html->url(array('controller' => 'patients', 'action' => 'poc_meds')); ?>" style="float: none;">Meds</a>
					   </td>
					   <td width="15">&nbsp;</td>   
					</tr>
				</table> 
...
<div id="lab_records_area" class="tab_area"> 
	<div id="poc_lab_form_area" style="padding-top:15px;">
		<table cellpadding="0" cellspacing="0" class="small_table" style="width: 100%;">
			<tr>
				<th>Injection</th><th width="15%">Date Performed</th>
			</tr>
			...
			foreach ($patient_order_items as $patient_order)
			{
				?>
							<tr>
								<td><?php echo $patient_order['EncounterPointOfCare']['injection_name']; ?></td>
								<td><?php echo __date($global_date_format, strtotime($patient_order['EncounterPointOfCare']['injection_date_performed'])); ?></td>					
							</tr>                      
				<?php
			}
			?>
