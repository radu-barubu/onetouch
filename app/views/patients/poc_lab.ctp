	...
	<div class="title_area">
		<div class="title_text">
			<table id="sub_tab_table">
					<tr>
					   <td>
							<a href="javascript:void(0);" class="poc_submenuitem active" url="<?php echo $html->url(array('controller' => 'patients', 'action' => 'poc_lab')); ?>" style="float: none;">Labs</a>
					   </td>
					   <td width="15">&nbsp;</td>   
					   <td> 
...
<div id="lab_records_area" class="tab_area"> 
	<div id="poc_lab_form_area" style="padding-top:15px;">
		<table cellpadding="0" cellspacing="0" class="small_table" style="width: 100%;">
			<tr>
				<th>Test Name/Procedure Name</th><th width="33%">Priority</th><th width="10%">Date Performed</th>
			</tr>
			...
			foreach ($patient_order_items as $patient_order)
			{
				?>
							<tr>
								...
								<td width="10%" ><?php echo __date($global_date_format, strtotime($patient_order['EncounterPointOfCare']['lab_date_performed'])); ?></td>					
							</tr>                      
				<?php
			}
			?>
