  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
              ...
              <td>
                <table cellPadding="1" cellSpacing="1" width="100%">
                  <tbody>
                    <tr id="ccrheaderrow">
                      <td>
                      	<?php if($enable_import): ?>
                      	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20px;">
                        	<tr>
                                <td id="error_msg1" class="error" style="display: none;"></td>
                            </tr>
                            <tr>
                                <td><span class="btn" onClick="parent.importPatient('<?php echo $folder; ?>', 'error_msg1', '<?php echo $validate_mode; ?>', '<?php echo $patient_id; ?>');">Import</span> <span class="btn" onClick="parent.closeImportIframe();">Cancel</span></td>
                            </tr>
                          </table>
                        <?php endif; ?>
                        <h1><span style="font-size: <?php echo ($display_settings['body_font_size'] + 2); ?>px;">Continuity of Care Record</span></h1><br/>
                        <table bgColor="#ffffcc" cellPadding="1" cellSpacing="3" id="ccrheader" width="75%">
                          <tbody>
                            <tr>
                              <td width="120"><strong>Date Created:</strong></td>
                              <td>
                    ...
                    <tr id="demographicsrow">
                      <td>
                        <span class="header"><strong>Patient Demographics</strong></span>
                        <br/>
                        <table cellspacing="0" cellpadding="0" id="demographics" class="small_table" width="100%">
                          <tbody>
                            <tr>
                              <th>Name</th>
                              <th>Date of Birth</th>
                                      ...
                                      <table class="internal">
                                        <tbody>
                                          <xsl:for-each select="a:IDs">
                                            <tr>
                                              <td width="50%" class="id_type">
                                                <xsl:value-of select="a:Type/a:Text"/>
                                              </td>
                                              <td width="50%" class="id_value">
                    ...
                    <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Alerts">
                        <tr id="alertsrow">
                          <td>
						  	<br/>
                            <span class="header"><strong>Alerts</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="alerts" cellpadding="0" cellspacing="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
					  ...
					  <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:AdvanceDirectives">
                        <tr id="advancedirectivesrow">
                          <td><br />
                            <span class="header"><strong>Advance Directives</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="advancedirectives" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Support">
                        <tr id="supportprovidersrow">
                          <td>
						  	<br />
                            <span class="header" id="supportproviders"><strong>Support Providers</strong></span>
                            <br/>
                            <table class="small_table" width="100%" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Role</th>
                                  <th>Name</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:FunctionalStatus">
                        <tr id="functionalstatus">
                          <td>
						  	<br />
                            <span class="header"><strong>Functional Status</strong></span>
                            <br/>
                            <table class="small_table" width="100%" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Problems">
                        <tr id="problemsrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Problems</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="problems" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Procedures">
                        <tr id="proceduresrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Procedures</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="procedures" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Medications">
                        <tr id="medicationsrow">
                          <td>
						  	<br />
                            <span class="header" id="medications"><strong>Medications</strong></span>
                            <br/>
                            <table class="small_table" width="100%" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Immunizations">
                        <tr id="immunizationsrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Immunizations</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="immunizations" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Code</th>
                                  <th>Vaccine</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:VitalSigns">
                        <tr id="vitalsignsrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Vital Signs</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="vitalsigns" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Vital Sign</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Encounters">
                        <tr id="encountersrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Encounters</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="encounters" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:SocialHistory">
                        <tr id="socialhistoryrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Social History</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="socialhistory" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:FamilyHistory">
                        <tr id="familyhistoryrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Family History</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="familyhistory" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Results/a:Result[a:Test/a:TestResult/a:Value!='']">
                        <tr id="resultsrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Results (Discrete)</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="results" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>LOINC</th>
                                  <th>Test</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Results/a:Result[a:Test/a:TestResult/a:Description/a:Text!='']">
                        <tr id="resultsreportrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Results (Report)</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="resultsreport" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Test</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Payers">
                        <tr id="insurancerow">
                          <td>
						  	<br />
                            <span class="header"><strong>Insurance</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="insurance" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:PlanOfCare">
                        <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan[a:Type/a:Text='Treatment Recommendation']">
                          <tr id="planofcarerow">
                            <td>
								<br />
                              <span class="header"><strong>Plan Of Care Recommendations</strong></span>
                              <br/>
                              <table class="small_table" width="100%" id="planofcare" cellspacing="0" cellpadding="0">
                                <tbody>
                                  <tr>
                                    <th>Description</th>
                        ...
                        <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan[a:Type/a:Text='Order']">
                          <tr id="planofcareordersrow">
                            <td>
								<br />
                              <span class="header"><strong>Plan Of Care Orders</strong></span>
                              <br/>
                              <table class="small_table" width="100%" id="planofcareorders" cellspacing="0" cellpadding="0">
                                <tbody>
                                  <tr>
                                    <th>Descripion</th>
                                    <th>Plan Status</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:HealthCareProviders">
                        <tr id="healthcareprovidersrow">
                          <td>
						  	<br />
                            <span class="header"><strong>Health Care Providers</strong></span>
                            <br/>
                            <table class="small_table" width="100%" id="healthcareproviders" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Role</th>
                                  <th>Name</th>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:References">
                        <tr id="referencesrow">
                          <td>
                            ...
                            <br/>
                            <table class="small_table" width="100%" id="references" cellspacing="0" cellpadding="0">
                              <tbody>
                                <tr>
                                  <th>Type</th>
                                  <th>Date</th>
        ...
        <br/>
        <span id="actors">
          <span class="header"><strong>Additional Information About People &amp; Organizations</strong></span>
          <xsl:if test="a:ContinuityOfCareRecord/a:Actors/a:Actor[a:Person]">
            <span id="people">
              <br/><br/><h4>People</h4>
              <table class="small_table" width="100%" id="actorstable" cellspacing="0" cellpadding="0">
                <tbody>
                  <tr>
                    <th>Name</th>
                    <th>Specialty</th>
          ...
          <xsl:if test="a:ContinuityOfCareRecord/a:Actors/a:Actor[a:Organization]">
            <span id="organizations">
				<br/><br/>
              <h4>Organizations</h4>
              <table class="small_table" width="100%" id="organizationstable" cellspacing="0" cellpadding="0">
                <tbody>
                  <tr>
                    <th>Name</th>
                    <th>Specialty</th>
          ...
          <xsl:if test="a:ContinuityOfCareRecord/a:Actors/a:Actor[a:InformationSystem]">
            <span id="informationsystems">
              <br/><h4>Information Systems</h4>
              <table class="small_table" width="100%" id="informationsystemstable" cellspacing="0" cellpadding="0">
                <tbody>
                  <tr>
                    <th>Name</th>
                    <th>Type</th>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px;">
              	<tr>
                    <td id="error_msg2" class="error" style="display: none;"></td>
                </tr>
                <tr>
                	<td><span class="btn" onClick="parent.importPatient('<?php echo $folder; ?>', 'error_msg2', '<?php echo $validate_mode; ?>', '<?php echo $patient_id; ?>');">Import</span> <span class="btn" onClick="parent.closeImportIframe();">Cancel</span></td>
                </tr>
              </table>
              <?php endif; ?>
            </span>
