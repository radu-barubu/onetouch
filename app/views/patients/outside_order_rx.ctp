		...
		<div class="title_text">
			<table id="sub_tab_table">
					<tr>
					   ...
					   <td width="15">&nbsp;</td>   
					   <td> 
							<a href="javascript:void(0);" class="outside_order_submenuitem " url="<?php echo $html->url(array('controller' => 'patients', 'action' => 'outside_order_radiology')); ?>" style="float: none;">Radiology</a>							 
					   </td>
					   <td width="15">&nbsp;</td>   
					   <td> 
					   ...
					   <td width="15">&nbsp;</td>   
					   <td> 
							<a href="javascript:void(0);" class="outside_order_submenuitem active" url="<?php echo $html->url(array('controller' => 'patients', 'action' => 'outside_order_rx')); ?>" style="float: none;">Rx</a>
					   </td>
					   <td width="15">&nbsp;</td>
					   <td> 
...
<div id="lab_records_area" class="tab_area"> 
	<div id="outside_order_lab_form_area" style="padding-top:15px;">
		<table cellpadding="0" cellspacing="0" class="small_table" style="width: 100%;" border=1>
			<tr>
			...
			foreach ($patient_outside_order_items as $patient_outsideorder)
			{
				?>
							<tr>
								<td><?php echo $patient_outsideorder['EncounterPlanRx']['diagnosis']; ?></td>
								<td><?php echo $patient_outsideorder['EncounterPlanRx']['drug']; ?></td>					
								<td><?php echo $patient_outsideorder['EncounterPlanRx']['status']; ?></td>					
								<td width="10%" ><?php echo __date($global_date_format, strtotime($patient_outsideorder['EncounterPlanRx']['date_ordered'])); ?></td>					
							</tr>                      
				<?php
			}
			?>
