		...
		<div class="title_text">
			<table id="sub_tab_table">
					<tr>
					   ...
					   <td width="15">&nbsp;</td>
					   <td> 
							<a href="javascript:void(0);" class="outside_order_submenuitem active" url="<?php echo $html->url(array('controller' => 'patients', 'action' => 'outside_order_referral')); ?>" style="float: none;">Referrals</a>
					   </td>
					   <td width="15">&nbsp;</td> 					      
					   <td> 
	...
	<div id="outside_order_lab_form_area" style="padding-top:15px;">
		<table cellpadding="0" cellspacing="0" class="small_table" style="width: 100%;">
			...
			foreach ($patient_outside_order_items as $patient_outsideorder)
			{
				?>
							<tr>
								<td><?php echo $patient_outsideorder['EncounterPlanReferral']['diagnosis']; ?></td>
								<td><?php echo $patient_outsideorder['EncounterPlanReferral']['referred_to']; ?></td>					
								<td><?php echo $patient_outsideorder['EncounterPlanReferral']['status']; ?></td>					
								<td width="10%" ><?php echo __date($global_date_format, strtotime($patient_outsideorder['EncounterPlanReferral']['date_ordered'])); ?></td>					
							</tr>                      
				<?php
			}
			?>
