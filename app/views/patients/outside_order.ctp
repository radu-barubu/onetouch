	...
	<div class="title_area">
		<div class="title_text">
			<table id="sub_tab_table">
					<tr>
					   <td>
							<a href="javascript:void(0);" class="outside_order_submenuitem active" url="<?php echo $html->url(array('controller' => 'patients', 'action' => 'outside_order')); ?>" style="float: none;">Labs</a>
					   </td>
					   <td width="15">&nbsp;</td>   
					   <td> 
	...
	<div id="outside_order_lab_form_area" style="padding-top:15px;">
		<table cellpadding="0" cellspacing="0" class="small_table" style="width: 100%;">
			...
			foreach ($patient_outside_order_items as $patient_outsideorder)
			{
				?>
							<tr>
								<td><?php echo $patient_outsideorder['EncounterPlanLab']['diagnosis']; ?></td>
								<td><?php echo $patient_outsideorder['EncounterPlanLab']['test_name']; ?></td>
								<td><?php echo $patient_outsideorder['EncounterPlanLab']['status']; ?></td>					
								<td width="10%" ><?php echo __date($global_date_format, strtotime($patient_outsideorder['EncounterPlanLab']['date_ordered'])); ?></td>					
							</tr>                      
				<?php
			}
			?>
