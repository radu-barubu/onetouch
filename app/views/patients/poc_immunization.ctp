		...
		<div class="title_text">
			<table id="sub_tab_table">
					<tr>
					   ...
					   <td width="15">&nbsp;</td>   
					   <td> 
							<a href="javascript:void(0);" class="poc_submenuitem active" url="<?php echo $html->url(array('controller' => 'patients', 'action' => 'poc_immunization')); ?>" style="float: none;">Immunization</a>
					   </td>
					   <td width="15">&nbsp;</td>
					   <td> 
